  ...
  return (
    ...
    >
      ...
      <span className='pl-2 hidden busuanzi_container_site_uv'>
        ...
        <br/>
        <h1>{title}</h1>
        <span className='text-xs font-serif'>Powered by <a href='https://github.com/tangly1024/NotionNext' className='underline text-gray-500 dark:text-gray-300'>NotionNext {siteConfig('VERSION')}</a>. <br/>
        本站由{' '}<a href='https://blogCDN.net' className='underline' target='_blank' rel='noopener noreferrer'>blogCDN</a>{' '}提供境内加速服务.</span></span>
    </footer>
  )
}
